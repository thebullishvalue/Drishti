"""
Tattva — Mūla tab: Price vs fair value, the mispricing gap, conviction, breadth, model quality.
तत्त्व (Tattva) — "Principle / Essence"

UI — Mūla engine visualization: the published fair-value LEVEL with its
...
def render_mula_tab(engine, ts_filtered, x_axis, x_title, signal, model_stats, regime_stats, ts, active_target):
    """Mūla tab — recursive valuation with violet system identity.
